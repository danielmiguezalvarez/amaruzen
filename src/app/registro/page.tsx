...
export default function RegistroPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // signIn con redirect:true lanza un error de navegación — es normal
    }
    setLoading(false);
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmar" className="block text-sm font-medium text-stone-700 mb-1">
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-stone-400 focus:border-transparent ${
                  confirmar && password !== confirmar ? "border-red-400 bg-red-50" : "border-stone-300"
                }`}
            ...
            <button
              type="submit"
              disabled={loading || (confirmar.length > 0 && password !== confirmar)}
          ...
          <button
            ...
            className="w-full py-2.5 px-4 border border-stone-300 rounded-lg text-sm font-medium text-stone-700 hover:bg-stone-50 flex items-center justify-center gap-2 transition-colors"
          >
